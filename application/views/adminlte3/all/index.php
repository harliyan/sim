  ...
  <div class="page-header row no-gutters py-4">
    <div class="col-12 col-sm-12 text-center text-sm-left mb-0">
      ...
      <h1 class="page-title">REPORT DATA TELECENTER</h1>
    </div>
  </div>
  <!-- End Page Header -->
    ...
    <div class="col-lg-2 col-md-2 col-sm-2">
        <a href="<?php echo base_url('admin/pdf_all'); ?>" class="form-control btn btn-danger"><i class="glyphicon glyphicon glyphicon-floppy-save"></i> Cetak PDF</a>
      </div> 
           ...
           <table id="example2" class="table table-bordered table-striped" style="width:auto">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: center;"><?php echo $datakpb -> kecamatan; ?></td>
                  <td style="text-align: center;"><a href="<?php echo base_url() ?>admin/all/details/<?php echo $datakpb->id_telecenter ?>" class="text-info"><?php echo $datakpb -> nama_telecenter; ?></td>
                  ...
                  <td style="text-align: center;"><?php echo $datakpb -> ket_2; ?></td>
                   <td style="text-align: center;">
                          <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/all/hapus/<?php echo $datakpb->id_telecenter ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
                        </td>
