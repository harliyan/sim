           ...
           <table id="example2" class="table table-bordered table-striped" style="width:auto">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: center;"><a href="<?php echo base_url() ?>surveyor/all/details/<?php echo $datakpb->id_telecenter ?>" class="text-info"><?php echo $datakpb -> nama_telecenter; ?></td>
