  ...
  <div class="row">
    <div class="col-lg-2 col-md-2 col-sm-2">
        <a href="<?php echo base_url('admin/pdf_kpu'); ?>" class="form-control btn btn-danger"><i class="glyphicon glyphicon glyphicon-floppy-save"></i> Cetak PDF</a>
      </div> 
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: center;"><?php echo $datakpu -> ket_2; ?></td>
                   <td style="text-align: center;">
                        <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>admin/kpu/edit_status/<?php echo $datakpu->id_telecenter ?>">Edit</a>
                          <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/kpu/hapus_kpb/<?php echo $datakpu->id_telecenter ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
                        </td>
                    <?php endforeach ?>
                  </tbody>
                </table>
