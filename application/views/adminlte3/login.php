...
<body class="hold-transition login-page">
  ...
  <div class="login-box">
    <div class="login-logo">
      <!-- <div>
        <img src="<?php print base_url('adminlte3/'); ?>dist/img/pekalongan.jpg" style="width: 10px height: 5px; z-index: 0;"  alt="User Image">
      </div> -->
      <font color="black">TELE<b> CENTER</b></font>
    </div>
    <!-- /.login-logo -->
    <div class="card">
