                ...
                <tr>
                  ...
                  <td style="text-align: center;"><?php echo $dataStatus -> status; ?></td>
                   <td style="text-align: center;">
                        <button class="btn btn-warning btn-sm" href="<?php echo base_url() ?>admin/status_perangkat/edit_status/<?php echo $dataStatus->id_stats ?>" disabled>Edit</button>
                          <button class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/status_perangkat/hapus_status/<?php echo $dataStatus->id_stats ?>" onclick="return confirm('Yakin ingin menghapus?')" disabled>Delete</button>
                        </td>
                    <?php endforeach ?>
                  </tbody>
                </table>
